...
ALTER TABLE "ptl_settings" ALTER COLUMN "category" DROP DEFAULT;--> statement-breakpoint
...
ALTER TABLE "ptl_settings" ALTER COLUMN "category" SET DEFAULT 'general'::ptl_settings_category;